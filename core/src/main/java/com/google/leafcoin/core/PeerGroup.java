...
import com.google.leafcoin.core.Peer.PeerHandler;
import com.google.leafcoin.discovery.PeerDiscovery;
import com.google.leafcoin.discovery.PeerDiscoveryException;
...
public class PeerGroup extends AbstractIdleService implements TransactionBroadcaster {
    ...
    // pipeline with the leafcoin serializer ({@code TCPNetworkConnection}) downstream
     ...
     * <a href="https://en.leafcoin.it/wiki/BIP_0014">BIP 14</a>.
     *
