 ...
 *
 * <p>Bitcoin transactions don't specify what they do directly. Instead <a href="https://en.leafcoin.it/wiki/Script">a
...
public class Script {
    ...
    public byte[] getPubKeyHash() throws ScriptException {
        ...
        // Otherwise, the third element is the hash of the public key, ie the leafcoin address.
     ...
     * logic is defined by <a href="https://en.leafcoin.it/wiki/BIP_0016">BIP 16</a>.</p>
     *
