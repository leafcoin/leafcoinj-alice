...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.google.leafcoin.core.BlockChain#getChainHead()}
     * or perhaps {@link com.google.leafcoin.core.BlockChain#getBestChainHeight()} which will run in constant time and
